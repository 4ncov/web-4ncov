    ...
    <div>
        ...
        <section class="listing">
            ...
            <div class="switch-tab">
                <span class="switch-tab__item" v-for="cat in categories" :key="cat" :class="isActived(cat)" @click="choosedLabel = cat">{{
                    cat
                }}</span>
            </div>
            <MaterialList :materials="materials" quantityTitle="可提供" addressTitle="供货地址"></MaterialList>
            <el-button class="materials-loadmore" v-on:click="loadMore" v-bind:loading="loadingMore" v-bind:disabled="!hasNextPage">
...
export default {
    ...
    methods: {
        isActived(label) {
            return label === this.choosedLabel ? 'active' : ''
        },
        dataProcessor() {
